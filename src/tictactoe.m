function tictactoe()
% TICTACTOE Spiele TicTacToe gegen das trainierte KNN
% Du bist Grün (+1), das KNN ist Blau (-1)
% Gib Züge als Zahl 1-9 ein (Numpad-Layout)
...
[~, move] = max(probs);
[i, j] = ind2sub([3,3], move);
end

function [i, j] = numpad_to_ij(num)
% Numpad-Zahl zu Matrix-Index
%  7 8 9    (1,1)(1,2)(1,3)
%  4 5 6 -> (2,1)(2,2)(2,3)
%  1 2 3    (3,1)(3,2)(3,3)
...
% Spielfeld anzeigen
symbols = {' ', 'O', 'X'};  % 0=leer, -1=O(blau), +1=X(grün)
fprintf('\n');
for row = 1:3
    for col = 1:3
